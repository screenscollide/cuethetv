...
exports.index = function(req, res){
  res.render('index', { title: 'ScreensCollide.com | Cue the TV' });
};
...
exports.tv = function(req, res){
	...
	if( userAgent.match( screenSm ) ){
		...
		res.render('tv', { title: 'ScreensCollide.com | Cue the TV: Television' } );
	}
};

exports.billboard = function(req, res){
	res.render('billboard', { title: 'ScreensCollide.com | Cue the TV: Billboard' } );
};